...
import AddBookGrid from './AddBookGrid';

export default {
  title: 'organisms/Book Grid',
  component: AddBookGrid,
} as ComponentMeta<typeof AddBookGrid>;
...
export const Primary: ComponentStory<typeof AddBookGrid> = () => <AddBookGrid gridData={booksData}/>;